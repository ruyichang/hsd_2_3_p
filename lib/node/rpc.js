...
class RPC extends RPCBase {
  ...
  async _createWork() {
    ...
    this.attemptMap.set(seedkey, attempt);
  ...
  async submitWork(args, help) {
    ...
    this.logger.info('[submitWork] seedkey_:', seedkey_);
    this.logger.info('[submitWork] seedkey_:%x', seedkey_);
    this.logger.info('[submitWork] seedkey_:%x', seedkey_.toString('hex'));
    ...
    return this.handleWork(data, seedkey_);
  }
